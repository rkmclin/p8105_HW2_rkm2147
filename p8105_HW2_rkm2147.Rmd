...
We will be cleaning the next dataset using a similar process
snp.csv
```{r}
...
final538_df = left_join(pols_df, snp_df, by = "month_name")

final538_df = left_join(final538_df, unemployment_df, by = "month_name")
